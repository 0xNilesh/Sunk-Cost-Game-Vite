...
const Pots = () => {
    ...
    return (
			...
			<Stack spacing={2} m={8} direction="row" justifyContent="center">
				<Button color="success" variant={active?"contained" : "outlined"} onClick={()=>setActive(!active)}>Active</Button>
				<Button color="error" variant={expired?"contained" : "outlined"} onClick={()=>setExpired(!expired)}>Expired</Button>
			</Stack>
					 <Grid
						container
